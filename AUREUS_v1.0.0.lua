--// AUREUS v1.0.0
--// Painel vermelho, menor, arrastável e com scroll
...
MainConstraint.MinSize = Vector2.new(420, 300)
MainConstraint.MaxSize = Vector2.new(720, 470)
...
MinimizeButton.MouseButton1Click:Connect(function()
	...
	if IsMinimized then
		Body.Visible = false
		Tween(Main, {Size = UDim2.new(0,360,0,55)}, 0.2)
	else
		Body.Visible = true
...
Tween(Main, {Size = StartSize}, 0.35)
