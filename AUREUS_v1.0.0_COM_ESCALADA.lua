...
WallToggle.Text = "ATIVAR MODO CENTRAL"
...
local function startWallClimb()
    ...
    wallClimbConnection = RunService.Heartbeat:Connect(function()
        ...
        -- Detecta uma superfície vertical imediatamente à frente do jogador.
        ...
        if result and result.Instance and math.abs(result.Normal.Y) < 0.35
        ...
        elseif WallStatus.Text == "Parede detectada: escalando." then
...
WallToggle.MouseButton1Click:Connect(function()
    ...
    if wallModeEnabled then
        ...
        WallToggle.Text = "DESLIGAR MODO CENTRAL"
        WallStatus.Text = "Modo de escalada ativo. Aproxime-se de uma parede e caminhe contra ela."
        WallStatus.TextColor3 = Colors.Success
        startWallClimb()
...
local function answerQuestion(question)
    ...
    elseif q:find("script") or q:find("painel") or q:find("aureus") then
        return "AUREUS v1.0.0 organiza as funções em abas como Home, Local Player, Executor, Scripts, Gear, Amigos e Players."
    else
